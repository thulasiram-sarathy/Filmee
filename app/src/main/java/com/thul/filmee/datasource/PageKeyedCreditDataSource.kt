...
class PageKeyedCreditDataSource (
                                 val id:Int,
                                 retryExecutor: Executor
) : PageKeyedDataSource<Int, CreditResponse.Cast>()

{
    ...
    override fun loadInitial(params: LoadInitialParams<Int>, callback: LoadInitialCallback<Int, CreditResponse.Cast>) {
            ...
            .enqueue(object : retrofit2.Callback<ResponseBody> {
                ...
                override fun onResponse(call: Call<ResponseBody>, response: Response<ResponseBody>) {
                    if (response.isSuccessful && response.code() == 200) {
                        ...
                        callback.onResult(reviewsListing.cast,null,2)
    ...
    override fun loadAfter(params: LoadParams<Int>, callback: LoadCallback<Int, CreditResponse.Cast>) {
        afterParams = params
        networkState.postValue(NetworkState.LOADING)
        tmdbService.getCastCrew(id, TMDB_KEY)
            .enqueue(object : retrofit2.Callback<ResponseBody> {
                ...
                override fun onResponse(call: Call<ResponseBody>, response: Response<ResponseBody>) {
                    ...
                    if (response.isSuccessful && response.code() == 200) {
                        ...
                        callback.onResult(reviewsListing.cast,null)
                        networkState.postValue(NetworkState.LOADED)
                        afterParams = null
    ...
    override fun loadBefore(params: LoadParams<Int>, callback: LoadCallback<Int, CreditResponse.Cast>) {
